...
CITY_COORDS = {"Київ": (30.5234, 50.4501), "Львів": (24.0297, 49.8397), "Одеса": (30.7326, 46.4825), "Харків": (36.2304, 49.9935), "Дніпро": (35.0462, 48.4647), "Вінниця": (28.4682, 49.2331), "Ужгород": (22.2879, 48.6208),
               ...
               "Будапешт": (19.0402, 47.4979), "Відень": (16.3738, 48.2082), "Бухарест": (26.1025, 44.4268), "Кишинів": (28.8638, 47.0105), "Амстердам": (4.9041, 52.3676), "Париж": (2.3522, 48.8566), "Мадрид": (-3.7038, 40.4168), "Барселона": (2.1686, 41.3874), "Валенсія": (-0.3763, 39.4699), "Аліканте": (-0.4810, 38.3452), "Ліон": (4.8357, 45.7640), "Марсель": (5.3698, 43.2965), "Ніцца": (7.2620, 43.7102), "Страсбург": (7.7521, 48.5734), "Лісабон": (-9.1393, 38.7223), "Порту": (-8.6291, 41.1579), "Рим": (12.4964, 41.9028), "Венеція": (12.3155, 45.4408), "Болонья": (11.3426, 44.4949), "Турин": (7.6869, 45.0703), "Неаполь": (14.2681, 40.8518), "Мілан": (9.1900, 45.4642),
...
def pricing_cfg():
    ...
    p.setdefault("currency", "UAH"); p.setdefault("eur_rate", 51.449); p.setdefault("rate_auto", True); p.setdefault("extra_hours", 3)
